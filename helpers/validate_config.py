...
class EnvParams(BaseModel):
	...
	# validate payoff_matrix has cooperate and defect and matches expected number of prsioners
...
class ConfigPath(BaseModel):
	...
	llm_agents: Dict[
		str, WardenConfig | PrisonerConfig | WardenFallbackResponse | PrisonerFallbackResponse
	]
