"""Environment registry for the Social Dilemma experiment."""
...
from environments.prisoners_dilemma.prisoners_dilemma import (
	EnvironmentConfig,
...
_REGISTRY: Dict[str, Tuple[type[EnvironmentConfig], type[MultiAgentEnvironment]]] = {
	'prisoners_dilemma': (EnvironmentConfig, PrisonersDilemmaEnvironment),
}
